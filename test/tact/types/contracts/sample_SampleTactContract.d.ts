...
export declare function storeSampleTactContract$Data(src: SampleTactContract$Data): (builder: Builder) => void;
export declare function loadSampleTactContract$Data(slice: Slice): {
    $$type: "SampleTactContract$Data";
    owner: Address;
    counter: bigint;
};
export declare const SampleTactContract_getterMapping: {
    [key: string]: string;
};
export declare class SampleTactContract implements Contract {
