...
; (function (globalObject) {
  ...
  *--------------------------------------------------------------------------------------------*/
  ...
  if (typeof define == 'function' && define.amd)
    define('@ijstech/ipfs-utils', function () { return { cidToSri, parse, hashItems, hashContent, hashFile, mergeOptions }; })
  // Node.js
  else if (typeof module != 'undefined' && module.exports)
    module.exports = { cidToSri, parse, hashItems, hashContent, hashFile, mergeOptions }
  // Browser
  else {
    if (!globalObject)
      globalObject = typeof self != 'undefined' && self ? self : window;
    globalObject.IPFSUtils = { cidToSri, parse, hashItems, hashContent, hashFile, mergeOptions };
  };
})(this);