...
async function bundleDapp(storage, RootPath) {
    ...
    if (scconfig) {
        ...
        let distLibDir = path_1.default.join(distDir, rootDir, scconfig.libDir || 'libs');
        ...
        if (scconfig.bundle) {
            ...
            ;
            await storage.writeFile(path_1.default.join(distDir, rootDir, 'bundle.json'), JSON.stringify(bundleLibs));
        }
        else
            await copyDependencies(scconfig.dependencies, true);
