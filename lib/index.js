...
exports.Compiler = exports.PackageManager = exports.resolveAbsolutePath = exports.Parser = void 0;
...
class PackageManager {
    constructor(options) {
        this._packages = {};
        this.packageImporter = options === null || options === void 0 ? void 0 : options.packageImporter;
    }
    ;
        ...
        if (!pack) {
            if (!this.packages[packName]) {
                if (this.packageImporter) {
                    ...
                    if (pack === null || pack === void 0 ? void 0 : pack.dts) {
