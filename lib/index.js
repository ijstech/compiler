...
exports.Compiler = exports.PackageManager = exports.resolveAbsolutePath = exports.bundle = exports.Path = exports.Parser = void 0;
...
;
async function bundle(storage, RootPath, SourcePath) {
    ...
    if (scconfig) {
        ...
        for (let name in scconfig.modules) {
            ...
            storage.copyAssets(path_1.default.join(scRootDir, scconfig.moduleDir || 'modules', module.path), distModulePath);
            await storage.mkdir(distModulePath);
            storage.writeFile(path_1.default.join(distModulePath, 'index.js'), pack.script || '');
        }
        ;
        let checkDeps = true;
        while (checkDeps) {
        ...
        if (packageConfig) {
            ...
            storage.writeFile(path_1.default.join(distDir, 'index.js'), pack.script || '');
            storage.writeFile(path_1.default.join(typesDir, 'index.d.ts'), pack.dts || '');
        }
        ;
    }
    ;
